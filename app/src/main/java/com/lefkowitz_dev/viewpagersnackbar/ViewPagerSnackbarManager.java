...
public class ViewPagerSnackbarManager {
    ...
    private static ViewPagerSnackbarManager sSnackbarManager;

    static ViewPagerSnackbarManager getInstance() {
        if (sSnackbarManager == null) {
            sSnackbarManager = new ViewPagerSnackbarManager();
        }
    ...
    private ViewPagerSnackbarManager() {
        mLock = new Object();
    ...
    public void show(int duration, Callback callback) {
        synchronized (mLock) {
            ...
            if (mCurrentSnackbar != null && cancelSnackbarLocked(mCurrentSnackbar,
                    ViewPagerSnackbar.Callback.DISMISS_EVENT_CONSECUTIVE)) {
    ...
    private void scheduleTimeoutLocked(SnackbarRecord r) {
        if (r.duration == ViewPagerSnackbar.LENGTH_INDEFINITE) {
        ...
        } else if (r.duration == ViewPagerSnackbar.LENGTH_SHORT) {
    ...
    private void handleTimeout(SnackbarRecord record) {
        synchronized (mLock) {
            if (mCurrentSnackbar == record || mNextSnackbar == record) {
                cancelSnackbarLocked(record, ViewPagerSnackbar.Callback.DISMISS_EVENT_TIMEOUT);
            }
        }
    }
